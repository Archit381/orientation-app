...
export const clubItems = [
    ...
    img3: require('../assets/events/soon.png')},
  {
    ...
    desc: 'CodeChef Chapter, founded in September 2022, readies students for coding, hosting weekly contests. We nurture skills from basics to advanced, aiming to keep stars on their CodeChef profiles.',
    ...
    cname: 'Vishesh Shah',
    vname: 'Adit Agrawal',
    chair: require('../assets/team/cc.png'),
    vc: require('../assets/team/ccv.png'),
    insta: 'https://www.instagram.com/codechef_bu/',
    web:'https://www.linkedin.com/company/codechef-bu/about',
  ...
  
  {
    ...
    web:'https://www.linkedin.com/in/alan-turing-club-bu-832127258/',
    ...
    desc: 'Data Science Club at Bennett University is where data enthusiasts come together. We explore data analysis, visualization, and machine learning to derive meaningful insights from data.' },
  {
    ...
    chair: require('../assets/team/alt.jpg'),
    vc: require('../assets/team/altv.jpg'),
    desc: 'Your doorway to Augmented Reality (AR) and Virtual Reality (VR) wonders! We are a community passionate about shaping the future with AR and VR technology. Join us in crafting immersive experiences and pushing boundaries. Lets redefine reality together!' ,
    vis: "Join us in an innovative hub, where you can explore, learn, and create with cutting-edge AR and VR tech. Be inspired to shape the industry's future alongside a passionate community of boundary-pushers.",
    pic: 'yes',
